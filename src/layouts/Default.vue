  ...
  <div class="font-sans text-gray-800 leading-normal flex flex-col min-h-screen">
    <header class="border-t-14 border-blue-700">
      <nav class="container mx-auto flex flex-col sm:flex-row justify-between items-center py-8">
        ...
        <ul class="uppercase tracking-wide font-bold flex items-center">
          <li class="mr-8">
            <a href="#" v-scroll-to="'#about'" class="text-gray-800 hover:text-gray-600">關於</a>
          </li>
          <li class="mr-8">
            <a href="#" v-scroll-to="'#articles'" class="text-gray-800 hover:text-gray-600">文章</a>
          </li>
          <li class="mr-8">
            <a href="#" v-scroll-to="'#contact'" class="text-gray-800 hover:text-gray-600">聯絡</a>
          </li>
          <li class="mr-8">
            <a href="#" v-scroll-to="'#subscribe'" class="text-gray-800 hover:text-gray-600">訂閱</a>
          </li>
        </ul>
      </nav>
    </header>
    ...
    <footer class="bg-blue-700 text-white">
      <div class="container mx-auto flex flex-col sm:flex-row items-center justify-between py-8">
        <div class="mb-8 sm:mb-0">&copy; 2019 澄煦顧問 版權所有</div>
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="mailto:hi@enlightency.com" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://medium.com/enlightency" target="_blank" class="text-white hover:text-gray-400">
              <svg width="24" height="24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M8.3,6v15.1c0,0.2-0.1,0.4-0.2,0.5c-0.1,0.1-0.3,0.2-0.5,0.2c-0.1,0-0.3,0-0.4-0.1l-6-3c-0.2-0.1-0.3-0.2-0.5-0.4s-0.2-0.4-0.2-0.6V3.1c0-0.2,0-0.3,0.1-0.4C0.8,2.5,1,2.5,1.1,2.5c0.1,0,0.3,0.1,0.6,0.2L8.3,6C8.3,6,8.3,6,8.3,6z M9.1,7.3L16,18.4L9.1,15V7.3z M23.6,7.6v13.5c0,0.2-0.1,0.4-0.2,0.5c-0.1,0.1-0.3,0.2-0.5,0.2c-0.2,0-0.4-0.1-0.6-0.2l-5.7-2.8L23.6,7.6z M23.6,6c0,0-1.1,1.8-3.3,5.4s-3.5,5.6-3.9,6.3l-5-8.1l4.2-6.8c0.1-0.2,0.4-0.4,0.7-0.4c0.1,0,0.2,0,0.3,0.1L23.6,6C23.6,6,23.6,6,23.6,6z"/></svg>
            </a>
          </li>

          <li class="mr-8">
            <a href="https://www.facebook.com/enlightency/" target="_blank" class="text-white hover:text-gray-400">
              <svg width="24" height="24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path class="st0" d="M23,0.5H2C1.2,0.5,0.5,1.2,0.5,2v21c0,0.8,0.7,1.5,1.5,1.5h11.2v-9h-3v-3.8h3V9.5c0-3.1,1.7-5.2,4.5-5.2c1.3,0,2.2,0,3,0V8h-1.5C17.8,8,17,8.8,17,10.2v1.5h3.8L20,15.5h-3v9h6c0.8,0,1.5-0.7,1.5-1.5V2C24.5,1.2,23.8,0.5,23,0.5z"/></svg>
            </a>
          </li>

          <li class="mr-8">
            <a href="https://www.youtube.com/channel/UCHqkD7PWLjzjqsKbclUzThQ" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://github.com/enlightency" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="">
            <a href="https://twitter.com/EnlightencyHQ" target="_blank" class="text-white hover:text-gray-400">
